...
class DrogueroUnidadControllerTest extends WebTestCase
{
    /*
    public function testCompleteScenario()
    {
        ...
        $crawler = $public->request('GET', '/droguerounidad/');
        $this->assertEquals(200, $public->getResponse()->getStatusCode(), "Unexpected HTTP status code for GET /droguerounidad/");
        $crawler = $public->click($crawler->selectLink('Create a new entry')->link());

        // Fill in the form and submit it
        $form = $crawler->selectButton('Create')->form(array(
            'sid_api_drugbundle_droguerounidad[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'sid_api_drugbundle_droguerounidad[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
