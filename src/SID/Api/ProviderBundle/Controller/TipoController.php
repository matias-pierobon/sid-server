...
use SID\Api\ProviderBundle\Entity\Tipo;
...
class TipoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tipos = $em->getRepository('ProviderBundle:Tipo')->findAll();
    ...
    {
        $tipo = new Tipo();
        $form = $this->createForm('SID\Api\ProviderBundle\Form\TipoType', $tipo);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('tipos_provider_show', array('id' => $tipo->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($tipo);
        $editForm = $this->createForm('SID\Api\ProviderBundle\Form\TipoType', $tipo);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('tipos_provider_edit', array('id' => $tipo->getId()));
        }
    ...
    public function deleteAction(Request $request, Tipo $tipo)
    {
        ...
        return $this->redirectToRoute('tipos_provider_index');
    }
    ...
    private function createDeleteForm(Tipo $tipo)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('tipos_provider_delete', array('id' => $tipo->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
