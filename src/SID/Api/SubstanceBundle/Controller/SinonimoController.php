...
class SinonimoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('SubstanceBundle:Sinonimo:index.html.twig', array(
            'sinonimos' => $sinonimos,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('SubstanceBundle:Sinonimo:new.html.twig', array(
            'sinonimo' => $sinonimo,
    ...
    public function showAction(Sinonimo $sinonimo)
    {
        ...
        return $this->render('SubstanceBundle:Sinonimo:show.html.twig', array(
            'sinonimo' => $sinonimo,
    ...
    public function editAction(Request $request, Sinonimo $sinonimo)
    {
        ...
        return $this->render('SubstanceBundle:Sinonimo:edit.html.twig', array(
            'sinonimo' => $sinonimo,
