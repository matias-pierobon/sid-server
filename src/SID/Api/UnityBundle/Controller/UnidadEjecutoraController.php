...
class UnidadEjecutoraController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('UnityBundle:Unidades:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('unidades_show', array('id' => $unidadEjecutora->getId()));
        }

        return $this->render('UnityBundle:Unidades:new.html.twig', array(
    ...
    public function showAction(UnidadEjecutora $unidadEjecutora)
    {
        ...
        return $this->render('UnityBundle:Unidades:show.html.twig', array(
            'unidadEjecutora' => $unidadEjecutora,
    ...
    public function editAction(Request $request, UnidadEjecutora $unidadEjecutora)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('unidades_edit', array('id' => $unidadEjecutora->getId()));
        }

        return $this->render('UnityBundle:Unidades:edit.html.twig', array(
            'unidadEjecutora' => $unidadEjecutora,
    ...
    private function createDeleteForm(UnidadEjecutora $unidadEjecutora)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('unidades_delete', array('id' => $unidadEjecutora->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
