...
class UsuarioUnidad
{
     ...
     * Set usuario
     *
     * @param \SID\Api\UnityBundle\Entity\User $usuario
     *
     * @return UsuarioUnidad
     */
    public function setUsuario(\SID\Api\UnityBundle\Entity\User $usuario = null)
    {
     ...
     * Get usuario
     *
     * @return \SID\Api\UnityBundle\Entity\User
     */
